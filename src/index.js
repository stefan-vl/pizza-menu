...
function Menu() {
    ...
    return (<main className="menu">
        ...
        {numPizzas>0 &&  (<ul className="pizzas">
            {pizzas.map(p => <Pizza pizzaObj={p} key={p.name}/>)}
        </ul>)}
        {/*<Pizza name='Pizza Spinaci' ingredients='Tomato, mozarella, spinach, and ricotta cheese'*/}
        {/*       photoName='pizzas/spi bnaci.jpg' price={10}/>*/}
        {/*<Pizza name='Pizza Fungi' ingredients='Tomato, mozarella, mushrooms, and onion'*/}
